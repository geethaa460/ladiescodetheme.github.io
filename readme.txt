=== Testimonial Flash Widget ===
Contributors: Jennifer Dao, Geethaa V., & Shruti Shirke
...
Testimonial widget plugin allows you display multiple testimonials in a sidebar on your WordPress blog. 

More than one widget can be displayed. Each displayed widget has its own identifier allowing for custom CSS styling.

**Features and notes**

* All testimonials can have filtures and are in the html source (so it will be seen by google).
* Testimony, author and source fields are clickable
* **Admin interface**: An admin interface to add, edit and manage testimonails for the client. This includes, information such as author and source of the testimonial along with tags and visibility. 

* **Sidebar widget**: The Testimonials sidebar widget loads a testimonial then flashes other testimonails that were inputted.  Following is the list of options in the widget control panel (backend):
	* Widget title
...
Styling can be done by editing the testimonials-widget.css file. 
